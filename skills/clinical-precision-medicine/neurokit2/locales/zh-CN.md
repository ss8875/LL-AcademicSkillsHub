...
用于分析生理数据的综合生物信号处理工具包，包括 ECG、EEG、EDA、RSP、PPG、EMG 和 EOG 信号。在处理心血管信号、大脑活动、皮肤电反应、呼吸模式、肌肉活动或眼球运动时使用此技能。适用于心率变异性分析、事件相关电位、复杂性测量、自主神经系统评估、心理生理学研究和多模态生理信号集成。
...
本技能按“输入契约 → 执行 → 验证 → 交付”工作。原始指令的重点阅读路径为：`能力概览` → `适用场景` → `核心能力与原则` → `模式与参数` → `安装与配置` → `工作流程` → `参考资料`。
...
> 请使用“Neurokit2”处理【临床问题、医学数据或证据资料】。目标是【写明研究目标】；请遵守【时间范围、对象范围、格式或方法约束】，输出【证据摘要、分析结果或结构化记录】，并列出关键步骤、证据来源、不确定性和需要人工确认的事项。

### 可直接改写的请求

- “请用 Neurokit2 完成整理临床与精准医学证据。我的材料是【临床问题、医学数据或证据资料】，结果请整理为【证据摘要、分析结果或结构化记录】。”
- “请先检查我提供的【临床问题、医学数据或证据资料】是否足够，再用 Neurokit2 执行标注适用边界与风险；不要补造缺失信息。”
- “请把 Neurokit2 的处理过程做成可复核记录，交付【证据摘要、分析结果或结构化记录】，同时标出假设、限制和下一步建议。”

## 5. 示例预览

| 环节 | 示例内容 |
|---|---|
| 任务目标 | 使用 **Neurokit2** 完成“整理临床与精准医学证据” |
| 输入材料 | 临床问题、医学数据或证据资料 |
...
- [`references/bio_module.md`](../references/bio_module.md)：方法、规范或领域约束参考。
- [`references/complexity.md`](../references/complexity.md)：方法、规范或领域约束参考。
- [`references/ecg_cardiac.md`](../references/ecg_cardiac.md)：方法、规范或领域约束参考。
- [`references/eda.md`](../references/eda.md)：方法、规范或领域约束参考。
- [`references/eeg.md`](../references/eeg.md)：方法、规范或领域约束参考。
- [`references/emg.md`](../references/emg.md)：方法、规范或领域约束参考。
- [`references/eog.md`](../references/eog.md)：方法、规范或领域约束参考。
- [`references/epochs_events.md`](../references/epochs_events.md)：方法、规范或领域约束参考。
- [`references/hrv.md`](../references/hrv.md)：方法、规范或领域约束参考。
- [`references/ppg.md`](../references/ppg.md)：方法、规范或领域约束参考。
- [`references/rsp.md`](../references/rsp.md)：方法、规范或领域约束参考。
...
- **本技能职责：**Neurokit2 聚焦于“组织临床、影像和分子证据，为研究分析与精确医学决策提供结构化支持”，负责完成“整理临床与精准医学证据；处理受控医学数据；标注适用边界与风险”。
