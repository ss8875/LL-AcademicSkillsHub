...
本技能按“输入契约 → 执行 → 验证 → 交付”工作。原始指令的重点阅读路径为：`能力概览` → `适用场景` → `专题说明` → `协同与集成` → `核心能力与原则` → `工作流程` → `与其他技能集成` → `应避免的问题`。
...
> 请使用“Latex Posters”处理【数据、论点、目标媒介】。目标是【写明研究目标】；请遵守【时间范围、对象范围、格式或方法约束】，输出【图表、海报、幻灯片或图形文件】，并列出关键步骤、证据来源、不确定性和需要人工确认的事项。

### 可直接改写的请求

- “请用 Latex Posters 完成设计学术图表与版式。我的材料是【数据、论点、目标媒介】，结果请整理为【图表、海报、幻灯片或图形文件】。”
- “请先检查我提供的【数据、论点、目标媒介】是否足够，再用 Latex Posters 执行输出演示或出版素材；不要补造缺失信息。”
- “请把 Latex Posters 的处理过程做成可复核记录，交付【图表、海报、幻灯片或图形文件】，同时标出假设、限制和下一步建议。”

## 5. 示例预览

| 环节 | 示例内容 |
|---|---|
| 任务目标 | 使用 **Latex Posters** 完成“设计学术图表与版式” |
| 输入材料 | 数据、论点、目标媒介 |
...
- [`references/latex_poster_packages.md`](../references/latex_poster_packages.md)：方法、规范或领域约束参考。
- [`references/poster_content_guide.md`](../references/poster_content_guide.md)：方法、规范或领域约束参考。
- [`references/poster_design_principles.md`](../references/poster_design_principles.md)：方法、规范或领域约束参考。
- [`references/poster_layout_design.md`](../references/poster_layout_design.md)：方法、规范或领域约束参考。
- [`references/README.md`](../references/README.md)：方法、规范或领域约束参考。

### 执行脚本（1）

- [`scripts/review_poster.sh`](../scripts/review_poster.sh)：可复用执行或验证脚本。

### 模板与素材（4）

- [`assets/baposter_template.tex`](../assets/baposter_template.tex)：可复用模板、样式或示例素材。
- [`assets/beamerposter_template.tex`](../assets/beamerposter_template.tex)：可复用模板、样式或示例素材。
- [`assets/poster_quality_checklist.md`](../assets/poster_quality_checklist.md)：可复用模板、样式或示例素材。
- [`assets/tikzposter_template.tex`](../assets/tikzposter_template.tex)：可复用模板、样式或示例素材。
...
- **本技能职责：**Latex Posters 聚焦于“把数据和论点转化为准确、易读、可编辑并适合传播的科研视觉材料”，负责完成“设计学术图表与版式；把数据转化为可读视觉；输出演示或出版素材”。
