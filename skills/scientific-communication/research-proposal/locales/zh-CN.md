...
为博士申请生成学术研究计划或研究提案，支持 STEM、人文与社会科学等不同领域，并能根据具体研究主题调整结构与论证方式。遵循严谨、凝练的学术写作规范，可按用户需要输出中文或英文版本。
...
本技能按“输入契约 → 执行 → 验证 → 交付”工作。原始指令的重点阅读路径为：`能力概览` → `工作流程` → `专题说明` → `方法与策略` → `参考资料` → `流程摘要` → `边界与问题排查`。
...
> 请使用“Research Proposal”处理【研究材料、目标体裁、读者要求】。目标是【写明研究目标】；请遵守【时间范围、对象范围、格式或方法约束】，输出【学术文本或交流材料】，并列出关键步骤、证据来源、不确定性和需要人工确认的事项。

### 可直接改写的请求

- “请用 Research Proposal 完成组织学术论证。我的材料是【研究材料、目标体裁、读者要求】，结果请整理为【学术文本或交流材料】。”
- “请先检查我提供的【研究材料、目标体裁、读者要求】是否足够，再用 Research Proposal 执行按受众和体裁调整内容；不要补造缺失信息。”
- “请把 Research Proposal 的处理过程做成可复核记录，交付【学术文本或交流材料】，同时标出假设、限制和下一步建议。”

## 5. 示例预览

| 环节 | 示例内容 |
|---|---|
| 任务目标 | 使用 **Research Proposal** 完成“组织学术论证” |
| 输入材料 | 研究材料、目标体裁、读者要求 |
...
- [`references/DOMAIN_TEMPLATES.md`](../references/DOMAIN_TEMPLATES.md)：方法、规范或领域约束参考。
- [`references/LITERATURE_WORKFLOW.md`](../references/LITERATURE_WORKFLOW.md)：方法、规范或领域约束参考。
- [`references/QUALITY_CHECKLIST.md`](../references/QUALITY_CHECKLIST.md)：方法、规范或领域约束参考。
- [`references/STRUCTURE_GUIDE.md`](../references/STRUCTURE_GUIDE.md)：方法、规范或领域约束参考。
- [`references/WRITING_STYLE_GUIDE.md`](../references/WRITING_STYLE_GUIDE.md)：方法、规范或领域约束参考。

### 模板与素材（2）

- [`assets/proposal_scaffold_en.md`](../assets/proposal_scaffold_en.md)：可复用模板、样式或示例素材。
- [`assets/proposal_scaffold_zh.md`](../assets/proposal_scaffold_zh.md)：可复用模板、样式或示例素材。
...
- **本技能职责：**Research Proposal 聚焦于“把证据、方法和结论组织为清楚、准确、适配目标读者的学术表达”，负责完成“组织学术论证；改善科学表达；按受众和体裁调整内容”。
