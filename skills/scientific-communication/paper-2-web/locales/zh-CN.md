...
将学术论文转换为宣传和演示格式（包括交互式网站 (Paper2Web)、演示视频 (Paper2Video) 和会议海报 (Paper2Poster) 时，应使用此技能。使用此技能来完成涉及论文传播、会议准备、创建可探索的学术主页、生成视频摘要或从 LaTeX 或 PDF 源生成可打印海报的任务。
...
本技能按“输入契约 → 执行 → 验证 → 交付”工作。原始指令的重点阅读路径为：`能力概览` → `适用场景` → `专题说明` → `核心能力与原则` → `快速开始` → `工作流程` → `输入要求` → `模式与参数`。
...
> 请使用“Paper 2 Web”处理【研究材料、目标体裁、读者要求】。目标是【写明研究目标】；请遵守【时间范围、对象范围、格式或方法约束】，输出【学术文本或交流材料】，并列出关键步骤、证据来源、不确定性和需要人工确认的事项。

### 可直接改写的请求

- “请用 Paper 2 Web 完成组织学术论证。我的材料是【研究材料、目标体裁、读者要求】，结果请整理为【学术文本或交流材料】。”
- “请先检查我提供的【研究材料、目标体裁、读者要求】是否足够，再用 Paper 2 Web 执行按受众和体裁调整内容；不要补造缺失信息。”
- “请把 Paper 2 Web 的处理过程做成可复核记录，交付【学术文本或交流材料】，同时标出假设、限制和下一步建议。”

## 5. 示例预览

| 环节 | 示例内容 |
|---|---|
| 任务目标 | 使用 **Paper 2 Web** 完成“组织学术论证” |
| 输入材料 | 研究材料、目标体裁、读者要求 |
...
- [`references/paper2poster.md`](../references/paper2poster.md)：方法、规范或领域约束参考。
- [`references/paper2video.md`](../references/paper2video.md)：方法、规范或领域约束参考。
- [`references/paper2web.md`](../references/paper2web.md)：方法、规范或领域约束参考。
- [`references/usage_examples.md`](../references/usage_examples.md)：方法、规范或领域约束参考。
...
- **本技能职责：**Paper 2 Web 聚焦于“把证据、方法和结论组织为清楚、准确、适配目标读者的学术表达”，负责完成“组织学术论证；改善科学表达；按受众和体裁调整内容”。
