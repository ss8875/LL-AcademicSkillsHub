...
| `codeSyntax` | `{"pythonFiles": 242, "pythonWarnings": 0, "jsFiles": 1, "jsFailures": 0}` |
| `securityStaticScan` | `{"files": 1609, "findings": {"dynamic-python": 15, "shell-pipe-exec": 2, "shell-true": 2}}` |
